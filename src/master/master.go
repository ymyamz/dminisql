...
type Master struct {
	...
	Owntablelist     map[string]*[]string // ip所有的tables
	TableIP          map[string]string    // table所在的ip
	Backup           map[string]string    // server ip -> backup ip
	Available        string               // available regions
	RegionIPList     []string			  // server ip list
