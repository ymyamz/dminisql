项目启动说明：
请把该项目按照distribute-mysql命名文件夹，放在gopath下。
...
可使用文件测试，指令如下 例如".read ./sql/test_100.txt;"（严格要求是.read加一个空格开头）test.txt文件内容中每行一个命令加分号
注意启动本项目还需要配置ftp服务器，具体参考入下：https://blog.csdn.net/qq_43810711/article/details/137294437